...
namespace ArcConfig
{
	partial class MainForm
	{
		...
		private System.Windows.Forms.TreeView treeViewA;
		private System.Windows.Forms.RadioButton radioButton4;
		private System.Windows.Forms.DataGridView dataGridViewA;
		private System.Data.DataSet dataSetA;
		...
		private System.Windows.Forms.BindingNavigator bindingNavigatorS;
		...
		private void InitializeComponent()
		{
			...
			this.bindingNavigatorS = new System.Windows.Forms.BindingNavigator(this.components);
			this.bindingNavigatorAddNewItem = new System.Windows.Forms.ToolStripButton();
			this.bindingSourceS = new System.Windows.Forms.BindingSource(this.components);
			...
			this.richTextBox1.Size = new System.Drawing.Size(1182, 550);
			...
			this.tabControl1.Size = new System.Drawing.Size(1190, 576);
			...
			this.tabPage1.Size = new System.Drawing.Size(1182, 550);
			...
			this.tabPage2.Size = new System.Drawing.Size(1182, 550);
			...
			// 
			this.splitContainer2.Panel1.Controls.Add(this.treeViewA);
			// 
			...
			// 
			this.splitContainer3.Panel1.Controls.Add(this.dataGridViewA);
			// 
			...
			this.dataGridViewA.ContextMenuStrip = this.contextMenuStripA;
			...
			this.contextMenuStripA.Size = new System.Drawing.Size(166, 160);
			// 
			// toolStripMenuItem1
			// 
			...
			this.groupBox2.Location = new System.Drawing.Point(14, 390);
			this.groupBox2.Name = "groupBox2";
			this.groupBox2.Size = new System.Drawing.Size(194, 50);
			this.groupBox2.TabIndex = 7;
			this.groupBox2.TabStop = false;
			// 
			// buttonProfile
			// 
			this.buttonProfile.Location = new System.Drawing.Point(6, 12);
			...
			// butVariable
			// 
			this.butVariable.Location = new System.Drawing.Point(105, 12);
			this.butVariable.Name = "butVariable";
			this.butVariable.Size = new System.Drawing.Size(85, 31);
			this.butVariable.TabIndex = 6;
			this.butVariable.Text = "Переменные";
			this.butVariable.UseVisualStyleBackColor = true;
			this.butVariable.Click += new System.EventHandler(this.ButVariableClick);
			// 
			// buttonVarSch
			// 
			...
			this.tabPage3.Size = new System.Drawing.Size(1182, 550);
			this.tabPage3.TabIndex = 2;
			this.tabPage3.Text = "Справочники\\Таблицы";
			...
			// 
			this.splitContainer4.Panel1.Controls.Add(this.treeViewS);
			// 
			// splitContainer4.Panel2
			// 
			this.splitContainer4.Panel2.Controls.Add(this.panel2);
			this.splitContainer4.Panel2.Controls.Add(this.panel1);
			this.splitContainer4.Size = new System.Drawing.Size(1182, 550);
			...
			this.treeViewS.Location = new System.Drawing.Point(0, 0);
			this.treeViewS.Name = "treeViewS";
			this.treeViewS.Size = new System.Drawing.Size(268, 550);
			this.treeViewS.TabIndex = 0;
			this.treeViewS.AfterSelect += new System.Windows.Forms.TreeViewEventHandler(this.TreeViewSAfterSelect);
			// 
			// panel2
			// 
			this.panel2.Controls.Add(this.dataGridViewS);
			this.panel2.Dock = System.Windows.Forms.DockStyle.Fill;
			this.panel2.Location = new System.Drawing.Point(0, 31);
			this.panel2.Name = "panel2";
			this.panel2.Size = new System.Drawing.Size(910, 519);
			...
			this.dataGridViewS.Size = new System.Drawing.Size(910, 519);
			this.dataGridViewS.TabIndex = 0;
			// 
			// panel1
			// 
			this.panel1.Controls.Add(this.bindingNavigatorS);
			...
			// bindingNavigatorS
			// 
			this.bindingNavigatorS.AddNewItem = this.bindingNavigatorAddNewItem;
			this.bindingNavigatorS.BindingSource = this.bindingSourceS;
			this.bindingNavigatorS.CountItem = this.bindingNavigatorCountItem;
			this.bindingNavigatorS.DeleteItem = this.bindingNavigatorDeleteItem;
			this.bindingNavigatorS.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
			...
			this.bindingNavigatorS.Location = new System.Drawing.Point(0, 0);
			this.bindingNavigatorS.MoveFirstItem = this.bindingNavigatorMoveFirstItem;
			this.bindingNavigatorS.MoveLastItem = this.bindingNavigatorMoveLastItem;
			this.bindingNavigatorS.MoveNextItem = this.bindingNavigatorMoveNextItem;
			this.bindingNavigatorS.MovePreviousItem = this.bindingNavigatorMovePreviousItem;
			this.bindingNavigatorS.Name = "bindingNavigatorS";
			this.bindingNavigatorS.PositionItem = this.bindingNavigatorPositionItem;
			this.bindingNavigatorS.Size = new System.Drawing.Size(910, 25);
			this.bindingNavigatorS.TabIndex = 0;
			this.bindingNavigatorS.Text = "bindingNavigator1";
			// 
			...
			this.toolStripButtonCommit.Image = ((System.Drawing.Image)(resources.GetObject("toolStripButtonCommit.Image")));
			...
			this.dataGridViewDB.DataError += new System.Windows.Forms.DataGridViewDataErrorEventHandler(this.DataGridViewDBDataError);
			// 
			// tabPage5
			// 
			...
			this.tabPage5.Size = new System.Drawing.Size(1182, 550);
			...
			// dataSetA
			// 
			this.dataSetA.DataSetName = "NewDataSet";
			// 
			// dataSetS
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.bindingNavigatorS)).EndInit();
