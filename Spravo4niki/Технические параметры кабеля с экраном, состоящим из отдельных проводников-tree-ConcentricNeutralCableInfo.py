...
csv_writer.writerow(
    ["about", "name", "sizeDescription", "material", "radius",
     "diameterOverJacket","diameterOverCore","diameterOverInsulation","diameterOverNeutral",
...
for book in root.findall("{http://iec.ch/TC57/CIM100#}ConcentricNeutralCableInfo"):
    print("")
    ...
    for element in book:
        ...
        if ele_tag=="{http://iec.ch/TC57/CIM100#}ConcentricNeutralCableInfo.diameterOverNeutral" :
            diameterOverNeutral = book.find(ele_tag).text or ""
    ...
    str1="INSERT INTO ConcentricNeutralCableInfo (ABOUT,NAME,sizeDescription,material,radius,diameterOverJacket,diameterOverCore, \
diameterOverInsulation,diameterOverNeutral,tapeThickness,sheathThickness,constructionKind,outerJacketKind, \
insulationEr,insulationErShield,shieldMaterial,shieldIsTransposed,shieldCrossSection, \
shieldGrounding,crossSection,underShieldScreenThickness,radialMoistureBarrierThicknes ) \
