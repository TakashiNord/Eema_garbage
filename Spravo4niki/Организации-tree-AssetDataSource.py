...
csv_writer.writerow(
    ["about", "name", "OrganisationRoleObjects"]
)
...
for book in root.findall("{http://so-ups.ru/2015/schema-cim16#}AssetDataSource"):
    print("")
    ...
    rdf_resource1 = "" # OrganisationRole.Objects
    ...
    str1="INSERT INTO AssetDataSource (ABOUT,NAME,OrganisationRoleObjects) \
