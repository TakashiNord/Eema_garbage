...
for book in root.findall("{http://so-ups.ru/2015/schema-cim16#}AssetType"):
    print("")
    ...
    rdf_resource1 = "" # AssetType.PSRTypes

    for element in book:

        ele_tag = element.tag
        
        if ele_tag=="{http://so-ups.ru/2015/schema-cim16#}AssetType.PSRTypes" :
        ...
        #print(ele_tag, " : ")
    csv_writer.writerow(
        [about,cim_IdentifiedObject_name,""]
        )

    str1="INSERT INTO AssetType (ABOUT,NAME,AssetTypePSRTypes ) \
          VALUES ('"+about+"','"+cim_IdentifiedObject_name+"','"+ "" + "');"
